...
- Setup configs
    - Download the sample config file <br>
        ...
        - ```wget https://raw.githubusercontent.com/thegreatfoxxgoddess/userge-x/alpha/config.env.sample -O config.env```
        - ```vim config.env```
    - Download the yml file for docker-compose
        - ```wget https://raw.githubusercontent.com/thegreatfoxxgoddess/userge-x/alpha/resources/docker-compose.yml```
